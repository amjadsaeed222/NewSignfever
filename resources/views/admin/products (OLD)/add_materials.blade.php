      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form enctype="multipart/form-data" class="form-horizontal" method="post" action="{{ url('api/admin/add-material') }}" name="add_material" id="add_material" >{{ csrf_field() }}
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <textarea name="description" id="description" row="5" cols="10"></textarea>
                </div>
              </div>
              <div class="control-group">
