      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form enctype="multipart/form-data" class="form-horizontal" method="post" action="{{ url('/api/admin/edit-product/'.$productDetails->slug) }}" name="edit_product" id="edit_product" novalidate="novalidate">{{ csrf_field() }}
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <textarea name="description" id="description">@php echo strip_tags(htmlspecialchars_decode($productDetails->description));
                    @endphp</textarea>
                </div>
              </div>
              <div class="control-group">
